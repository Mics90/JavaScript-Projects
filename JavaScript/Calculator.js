...
const Calculator = {
    ...
    First_Operand: null,
    //this checks whether or not the secound operand has been input
...
function Input_Decimal(dot) {
    ...
    if (Calculator.Wait_Secound_Operand === true) return;
...
function Handle_Operator(Next_Operator) {
    ...
    //displayed on the first screen to a number and then store the result in 
    ...
    if (operator && Calculator.Wait_Second_Operand) {
        ...
        if (First_Operand == null) {
            ...
            //if operator exists, propertuy lookup is performed for the operator
